...
rm -f ~/.local/share/nautilus-python/extensions/nautilus-extensions.py

# Download and install the extension
echo "Downloading newest version..."
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/nautilus-extensions.py https://raw.githubusercontent.com/vuxuanhoang000/he-dieu-hanh/master/software/nautilus-extensions.py
# Restart nautilus
